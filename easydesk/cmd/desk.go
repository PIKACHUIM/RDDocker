...
import (
	...
	"github.com/pikachuim/easydesk/internal/forward"
...
func runStop(_ *cobra.Command, args []string) error  { eng, err := getEngine(); if err != nil { return err }; return eng.Stop(args[0]) }
func runStart(_ *cobra.Command, args []string) error { eng, err := getEngine(); if err != nil { return err }; return eng.Start(args[0]) }
func runRestart(_ *cobra.Command, args []string) error { eng, err := getEngine(); if err != nil { return err }; return eng.Restart(args[0]) }
